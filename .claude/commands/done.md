...
**Application log file location:** `/tmp/app.log`

Use the application logs to analyze errors and behavior:
...
# Search for errors
grep -i "error" /tmp/app.log | tail -50

# Search for specific patterns
grep -i "pattern" /tmp/app.log
```
